...
% So are Acknowledgments (proper English spelling)
	...
	%I'd like to take a moment to thank all the people who have been a part of the great moments in my life, you know who you are even if your name does not appear below it does not detract from the glory of our time spent together. I'd like to specifically thank
	%Cara Chae-Banks, Yoel ``Yoelie'' Ferdman, Siena Ward,  Alon ''Alonie'' Averbuj, Yarden Refaeli (aka DJ Fast Dad), Samuel ``SandBird'' Polterock , Rosa ``Avacado'' Brotherton, Josh ``Bayz'' Biase (aka DJ Flat Soda), Bryant Volk (aka DJ Strong Nerd), Manny Harpin, Michael Kaplan, and Cody Biesanz in no particular order for their incredible friendship.  
	
	%\par I'd also like to thank Sue Coles, Sierra Gomez-Saltzman, Kiote Coles, Tillie Castro, and especially Jody Saltzman and Dan Michaels for all the familial support and love over the years, there are no words for the gratitude I feel to have been raised in such an incredible family.
	%\par I'd like to thank my thesis advisor Dylan McNamee for his patients, advice, pep talks, and positivity throughout this thesis process. The idea of writing a thesis has always horrified me, but you did a great job keeping it fun and calming me down when I got anxious.
...
{} & \text{\small KeyGen}(f,MSK) \rightarrow SK_{f} \arrow[l, "\text{secure}(SK_f)"'] &  \\
 &  & \text{\small Enc}_{PP}(m_1)\rightarrow c_1 \\[-28]
 &  & \vdots \\[-25pt]
 &  & \text{\small Enc}_{PP}(m_n)\rightarrow c_n \\
{} &  & {} \arrow[ll] \{c_1, \cdots, c_n \} \\
\text{\small Dec}_{SK_{f}}(c_1) \rightarrow b_1 &  &  \\[-28pt]
\vdots &  &  \\[-25pt]
\text{ \small Dec}_{SK_{f}}(c_n) \rightarrow b_n &  & 
\end{tikzcd}
...
\toprule % a horizontal line, slightly thicker than \hline, depends on the booktabs package
  input length: &4 & 8 & 16 &32 \\ % the first row of the table. Separate columns with ampersands and end the line with two backslashes. An environment begun in one cell will not carry over to adjacent rows.
